...
urlpatterns = [
    ...
    path('organizacao/eventos/<int:event_id>/etiquetas/lote/', views.print_badges_batch_view, name='print_badges_batch'),
    ...
    path('organizacao/inscricao/<int:registration_id>/reenviar-email/', views.participant_resend_email, name='participant_resend_email'),
    path('organizacao/participante/<int:participant_id>/', views.participant_detail,name='participant_detail'),
    path('organizacao/usuarios/', views.users_admin_view, name='users_admin'),
    path('organizacao/usuarios/novo/', views.user_create_view, name='user_create'),
    path('organizacao/usuarios/<int:organizer_id>/editar/', views.user_edit_view, name='user_edit'),
    #path("participantes/<int:pk>/reenviar-email/", views.participant_resend_email, name="participant_resend_email"),
